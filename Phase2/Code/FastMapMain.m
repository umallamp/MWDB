...
[ mappingError, reducedObjectSpace, pivotArray, distanceInOriginalSpace, distanceInReducedSpace ] = getFastMapReducedSpace( datasetDir, similarityMeasureChoice, reducedDimensions, connectivityGraphLoc );
...
while true
    ...
    [ similarFiles, similarityScores, reducedQuerySpace ] = getFastMapSimilarSimulations( queryPath, reducedDimensions, similarFileRequired, reducedObjectSpace, pivotArray, datasetDir, distanceInOriginalSpace, similarityMeasureChoice, connectivityGraphLoc  );
